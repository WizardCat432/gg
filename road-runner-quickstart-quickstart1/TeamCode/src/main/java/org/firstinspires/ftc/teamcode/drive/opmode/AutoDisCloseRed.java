...
@Autonomous(name="AutoDisCloseRed")
public class AutoDisCloseRed extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence middleRF = drive.trajectorySequenceBuilder(new Pose2d(11, -63.50, Math.toRadians(90)))
        ...
        //strafe
        TrajectorySequence strafeRF = drive.trajectorySequenceBuilder(new Pose2d(11, -63.50, Math.toRadians(90)))
                .strafeRight(13)
                .build();
